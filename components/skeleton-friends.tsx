...
const FriendsSkeletonLoading = () => {
  return (
    <div className="min-h-screen flex flex-col text-white space-y-6 p-6 overflow-x-hidden">
      ...
      <div className="h-8 w-1/2 bg-gray-700 rounded-lg skeleton-shine"></div>

      {/* Friends list skeleton */}
      <div className="space-y-4 flex-grow">
        {[...Array(5)].map((_, index) => (
          <div key={index} className="h-16 bg-gray-700 rounded-lg flex items-center space-x-4 p-4 skeleton-shine">
      ...
      <div className="h-10 bg-gray-700 rounded-lg skeleton-shine"></div>
